...
% \begin{frame}{Módszerek}
%     \begin{itemize}
%         \item Periodicitás és trendek alapján
%         \item Geomágneses aktivitás: minimum környékén nézik, kettébontható (flerek és CME) + nagy sebességű napszél 
%         \item ...
%         \item Itt: idősor-analízis mély neurális hálókkal
%     \end{itemize}
% \end{frame}
